...
<style>
    * {
    ...
    body {
        background-image: url(../user/assets/img//hero/6.jpg);
            ...
            <div class="col-4 p-4" style="border-radius: 15px">
                ...
                <form class="user" action="" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" name="nama" placeholder="Masukkan nama" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control form-control-user" id="exampleInputPassword" name="password2" placeholder="Konfirmasi Password" />
                    </div>
                    <button type="submit" class="btn btn-primary btn-user btn-block" name="daftar">Daftar</button>
                </form>
                <div class="text-center mt-3">
                    <p class="text-white">
                        Sudah punya akun? <span> <a href="login.php" class="text-white" style="text-decoration: none;">Login</a></span>
                    </p>
                </div>
            </div>
        </div>
