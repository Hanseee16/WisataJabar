...
<head>
    ...
    <title>SIG Jawa Barat | Dashboard</title>
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto ml-3">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        <?= number_format($jml_kategori_gunung); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto mr-3">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ml-3">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Kategori Pantai</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?= number_format($jml_kategori_pantai); ?>
                                            </div>
                                        </div>
                                        <div class="col-auto mr-3">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2 ml-3">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Kategori Curug</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?= number_format($jml_kategori_curug); ?>
                                            </div>
                                        </div>
                                        <div class="col-auto mr-3">
                                            <!-- <i class="bi bi-bucket-fill fa-2x text-gray-300"></i> -->
