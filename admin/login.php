...
<head>
    ...
    <title>SIG Jawa Barat | Masuk</title>
...
<style>
    * {
    ...
    body {
        /* background-image: url(../user/assets/img/hero/StockSnap_ZJXS6NHIC1.jpg); */
        /* background-image: url(../user/assets/img/hero/pexels-dipankar-layek-16231632.jpg); */
        background-image: url(../user/assets/img/pantai/camille-bismonte-uMsa0Hwg2q8-unsplash.jpg);
        ...
        <div class="row" style="display: flex; justify-content: center; align-items: center; height: 100vh">
            <div class="col-4 p-4">
                ...
                <form class="user" action="" method="post">
                    ...
                    <button type="submit" class="btn btn-user btn-block text-white mb-3" style="background-color: #0245bc;" name="login">Masuk</button>
                </form>
